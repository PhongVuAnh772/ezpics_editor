...
export default function ModalTransaction() {
    const [loadingBtnInside, setLoadingBtnInside] = React.useState(false);
  ...
  const [dataNot, setDataAvailable] = React.useState(false);
          ...
          <div style={{}}>
            ...
            >
              ...
              {authentication ? (
                ...
                >
                  <b>
                    <span style={{ color: "rgba(13, 18, 22, 0.7)" }}>
                      Tên :
                    </span>{" "}
                    {infoUser[0]?.name}
                  </b>
            ...
            >
              <div style={{ display: "flex", flexDirection: "row",justifyContent:'space-between' }}>
                ...
                >
                  <p style={{fontWeight: 'bold'}}>Quý khách thực hiện chuyển khoản ngân hàng theo thông tin :</p>
                  <p
                  style={{
                    fontFamily:
                      "Noto Sans Vietnamese,-apple-system,BlinkMacSystemFont,Segoe UI,Helvetica,Arial,sans-serif",
                ...
                ><img src={dataUp?.link_qr_bank} alt="" style={{width:'80%',height: "80%"}}/></div>
              </div>
                                <p style={{fontWeight: 'bold',textAlign:"center",margin: 0,paddingTop: '5%'}}>Lưu ý: Sau khi thực hiện giao dịch, hãy nhấn nút <b>Kiểm tra giao dịch</b></p>
          ...
          <div style={{}}>
            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
              ...
              >
                ...
                {loadingBtnInside ? <span class="loader-create-film"></span> : 'Chấp nhận nạp tiền'}
              </Button>
            </div>
          </div>
        )}
