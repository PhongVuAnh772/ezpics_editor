 ...
 const {
  ...
  return (
    <Block $style={{ display: "flex", alignItems: "center" }}>
      ...
      <StatefulTooltip placement={PLACEMENT.bottom} showArrow={true} accessibilityType={"tooltip"} content="Xóa Layers đã chọn">
...
function CommonLayers() {
  ...
  return (
    ...
    >
      <Block>
        <StatefulTooltip placement={PLACEMENT.bottom} showArrow={true} accessibilityType={"tooltip"} content="Chỉnh thứ tự Layers">
...
function CommonAlign() {
  ...
  return (
    ...
    >
      <Block>
        <StatefulTooltip placement={PLACEMENT.bottom} showArrow={true} accessibilityType={"tooltip"} content="Chỉnh vị trí">
          <Button size={SIZE.mini} kind={KIND.tertiary}>
            <AlignCenter size={24} />
          </Button>
        </StatefulTooltip>
...
function LockUnlock() {
  ...
  return (
    <>
      {state.locked ? (
        <StatefulTooltip placement={PLACEMENT.bottom} showArrow={true} accessibilityType={"tooltip"} content="Khóa Layers">
          <Button
            onClick={() => {
