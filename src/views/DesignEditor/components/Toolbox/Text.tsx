    ...
    >
      <Block display={"flex"} gridGap="0.5rem" alignItems={"center"}>
        ...
        <Block display={"flex"} alignItems={"center"}>
          ...
          <StatefulTooltip placement={PLACEMENT.bottom} showArrow={true} accessibilityType={"tooltip"} content="In đậm">
            <Button
          ...
          <StatefulTooltip placement={PLACEMENT.bottom} showArrow={true} accessibilityType={"tooltip"} content="In nghiêng">
            <Button
...
function TextLetterCase() {
  ...
  const editor = useEditor()
  return (
    <StatefulTooltip placement={PLACEMENT.bottom} showArrow={true} accessibilityType={"tooltip"} content="Định dạng chữ">
      <Button
        onClick={() => {
          if (!state.upper) {
            setState({ upper: true })
...
function TextSpacing() {
  ...
  return (
    ...
    >
      <Block>
        <StatefulTooltip placement={PLACEMENT.bottom} showArrow={true} accessibilityType={"tooltip"} content="Chỉnh chiều cao/ Cách đều">
...
function TextAlign() {
  ...
  return (
    ...
    >
      <Block>
        <StatefulTooltip placement={PLACEMENT.bottom} showArrow={true} accessibilityType={"tooltip"} content="Căn lề">
          <Button size={SIZE.mini} kind={KIND.tertiary}>
            <TextAlignCenter size={24} />
          </Button>
        </StatefulTooltip>
